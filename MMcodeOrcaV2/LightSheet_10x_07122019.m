...
shutter2 = addAnalogOutputChannel(s2,'Board1','Ao0','Voltage');
galvoX2 = addAnalogOutputChannel(s2,'Board1', 'Ao1', 'Voltage');
galvoY2= addAnalogOutputChannel(s2,'Board1', 'Ao3', 'Voltage');
galvoZ2= addAnalogOutputChannel(s2,'Board1', 'Ao2', 'Voltage');
...
controlParameters = struct('MMC', mmc, 'cameraLabel', cameraLabel, 'stageLabel', stageLabel, ...
    'sFWDet', sFWDet,'sFWExt',sFWExt, 'sExtLens1', sExtLens1, 'sExtLens2', sExtLens2,'sDetLens',...
    sDetLens,'afg', afg,'shutter1',shutter1,'shutter2',shutter2, 'galvoX1',galvoX1,'galvoX2',galvoX2,'galvoY1',galvoY1,...
    'galvoY2',galvoY2,'s1',s1,'s2',s2);
...
%488 nm 
fprintf(sExtLens1,['1PA','4']);
fprintf(sExtLens2,['1PA','4']);
disp('lasers set up.')
if (avilableLasers(1))
